...
:::tip這些是預設快捷鍵，而且您可以全部[變更](/zh-tw/configure/custom-hotkeys)！:::
...
:::note 離開 superfile 並 cd 到目前資料夾的 `cd_quit` 需要與 [`cd_on_quit`](/zh-tw/configure/superfile-config/#cd_on_quit) 設定相同的腳本。:::
